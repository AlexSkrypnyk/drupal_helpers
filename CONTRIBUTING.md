...
This document explains how to report issues, set up a local development environment, build the site, check coding standards, and run the tests.
...
- README API reference freshness with `php docs.php --fail-on-change`.
...
Regenerate the README API reference with `php docs.php` after changing helper
docblocks.
