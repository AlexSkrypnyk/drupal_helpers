...
class Module extends \Drupal\drupal_helpers\System {
   ...
   */
  public function enable($module, $enable_dependencies = TRUE) {
   ...
   * @throws \DrupalUpdateException
   */
  public function disable($module, $disable_dependents = TRUE) {
   ...
   *
   * @return bool
   *  - TRUE: Module was unisntalled successfully.
   */
  public function uninstall($module, $disable_dependents = TRUE) {
